...
- 🔍 **近景浏览模式**：点击天体进入沉浸式近距离观察
- 🎮 **智能相机控制**：自定义球坐标控制系统，平滑流畅的视角转换
- 🎨 **动态分辨率**：近景模式下自动提升几何体分辨率至超高清
...
### 近景浏览模式
- **鼠标左键拖拽**：围绕天体旋转观察（自定义球坐标控制）
- **ESC键**：退出近景模式返回普通观察
- **自动Toast提示**：显示当前观察的天体信息
...
### 最新版本
- ✅ **天体近景浏览系统**：点击天体进入沉浸式近距离观察模式
- ✅ **自定义相机控制**：实现球坐标控制系统，解决OrbitControls鼠标控制问题
- ✅ **动态几何体分辨率**：近景模式自动提升至128×128/64×64超高分辨率
- ✅ **Toast通知系统**：提供实时用户操作反馈和提示
- ✅ **智能内存管理**：动态几何体切换，优化性能和内存使用
- ✅ 实现真实太阳日冕光晕效果
- ✅ 添加 Windows 平台开发支持
- ✅ 重构项目结构，统一类型定义位置
- ✅ 修复跨平台编译路径兼容性问题
